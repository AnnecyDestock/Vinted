...
extraTranslations.it={
  standardCards:"CARTE STANDARD",standardCardsInfo:"Tutte le carte con numerazione normale",
  numberOneCards:"CARTE NUMERO 1 E 13",numberOneCardsInfo:"Le carte numero 1 e 13 di ogni Paese",
  fwcCards:"CARTE FWC",fwcCardsInfo:"Tutte le carte della serie FWC",
  cardsAvailable:"carte disponibili",catalogue:"IL CATALOGO",availableCards:"Carte disponibili",
  searchCards:"Cerca una carta o un Paese...",referencesInStock:"{count} tipi di carte disponibili",
  available:"disponibili",inStock:"{count} disponibili",soldOut:"Esaurita",
  basketEmpty:"La tua selezione è vuota.",basketHint:"Aggiungi le carte dal catalogo.",
  subtotal:"Subtotale",total:"Totale",noMatch:"Nessuna carta corrisponde alla ricerca.",
  pending:"Hai delle richieste in attesa.",pendingDetails:"{orders} richiesta/e · {units} carte in totale · {unique} riferimenti unici · {amount}. Il venditore ha ricevuto la richiesta e ti contatterà su Vinted.",
  yourSelection:"LA TUA SELEZIONE",basket:"Carrello",clearSelection:"Svuota la selezione",
  reservedOnConfirm:"Le carte vengono prenotate dopo la conferma",
  confirmRequest:"CONFERMA LA RICHIESTA",sendRequestFor:"Inviare una richiesta per {count} carte?",
  checkSelection:"Il totale è {amount}. Controlla la tua selezione:",
  emailConsent:"Confermo di voler inviare questa richiesta al venditore tramite e-mail. Il venditore mi contatterà attraverso il mio nome utente Vinted.",
  goBack:"Indietro",confirmEmail:"Conferma e invia al venditore",requestConfirmed:"RICHIESTA CONFERMATA",
  cardsReserved:"Le tue carte sono state prenotate!",emailSuccess:"Il venditore ha ricevuto l’e-mail e ti contatterà su Vinted.",
  emailNotSent:"La richiesta è stata salvata, ma l’invio dell’e-mail richiede attenzione.",copyBackup:"Copia il messaggio di riserva"
};
...
const fullLocaleKeys=["standardCards","standardCardsInfo","numberOneCards","numberOneCardsInfo","fwcCards","fwcCardsInfo","cardsAvailable","catalogue","availableCards","searchCards","referencesInStock","available","inStock","soldOut","basketEmpty","basketHint","subtotal","total","noMatch","pending","pendingDetails","yourSelection","basket","clearSelection","reservedOnConfirm","confirmRequest","sendRequestFor","checkSelection","emailConsent","goBack","confirmEmail","requestConfirmed","cardsReserved","emailSuccess","emailNotSent","copyBackup"];
const fullLocalePacks={
de:["STANDARDKARTEN","Alle regulär nummerierten Karten","KARTEN NUMMER 1 UND 13","Die Karten Nummer 1 und 13 jedes Landes","FWC-KARTEN","Alle Karten der FWC-Serie","Karten verfügbar","DER KATALOG","Verfügbare Karten","Karte oder Land suchen...","{count} Kartentypen auf Lager","verfügbar","{count} auf Lager","Ausverkauft","Deine Auswahl ist leer.","Füge Karten aus dem Katalog hinzu.","Zwischensumme","Gesamt","Keine Karten entsprechen deiner Suche.","Du hast offene Anfragen.","{orders} Anfrage(n) · {units} Karten insgesamt · {unique} verschiedene Referenzen · {amount}. Der Verkäufer hat deine Anfrage erhalten und kontaktiert dich auf Vinted.","DEINE AUSWAHL","Warenkorb","Auswahl leeren","Die Karten werden nach der Bestätigung reserviert","ANFRAGE BESTÄTIGEN","Anfrage für {count} Karten senden?","Gesamtbetrag: {amount}. Bitte prüfe deine Auswahl:","Ich bestätige, dass diese Anfrage per E-Mail an den Verkäufer gesendet werden soll. Er kontaktiert mich über meinen Vinted-Benutzernamen.","Zurück","Bestätigen und senden","ANFRAGE BESTÄTIGT","Deine Karten wurden reserviert!","Der Verkäufer hat die E-Mail erhalten und kontaktiert dich auf Vinted.","Die Anfrage wurde gespeichert, aber die E-Mail konnte nicht zugestellt werden.","Ersatznachricht kopieren"],
es:["CARTAS ESTÁNDAR","Todas las cartas con numeración normal","CARTAS NÚMERO 1 Y 13","Las cartas número 1 y 13 de cada país","CARTAS FWC","Todas las cartas de la serie FWC","cartas disponibles","EL CATÁLOGO","Cartas disponibles","Buscar carta o país...","{count} tipos de cartas disponibles","disponibles","{count} disponibles","Agotada","Tu selección está vacía.","Añade cartas desde el catálogo.","Subtotal","Total","Ninguna carta coincide con tu búsqueda.","Tienes solicitudes pendientes.","{orders} solicitud(es) · {units} cartas en total · {unique} referencias únicas · {amount}. El vendedor recibió tu solicitud y te contactará por Vinted.","TU SELECCIÓN","Carrito","Vaciar selección","Las cartas se reservan después de confirmar","CONFIRMAR SOLICITUD","¿Enviar una solicitud de {count} cartas?","El total es {amount}. Revisa tu selección:","Confirmo que deseo enviar esta solicitud al vendedor por correo electrónico. Me contactará mediante mi usuario de Vinted.","Volver","Confirmar y enviar","SOLICITUD CONFIRMADA","¡Tus cartas están reservadas!","El vendedor recibió el correo y te contactará por Vinted.","La solicitud se guardó, pero no se pudo enviar el correo.","Copiar mensaje alternativo"],
nl:["STANDAARDKAARTEN","Alle normaal genummerde kaarten","KAARTEN NUMMER 1 EN 13","De kaarten nummer 1 en 13 van elk land","FWC-KAARTEN","Alle kaarten uit de FWC-serie","kaarten beschikbaar","DE CATALOGUS","Beschikbare kaarten","Zoek kaart of land...","{count} kaartsoorten op voorraad","beschikbaar","{count} op voorraad","Uitverkocht","Je selectie is leeg.","Voeg kaarten toe vanuit de catalogus.","Subtotaal","Totaal","Geen kaarten gevonden.","Je hebt openstaande aanvragen.","{orders} aanvraag/aanvragen · {units} kaarten totaal · {unique} unieke referenties · {amount}. De verkoper heeft je aanvraag ontvangen en neemt contact op via Vinted.","JOUW SELECTIE","Winkelmand","Selectie wissen","Kaarten worden na bevestiging gereserveerd","AANVRAAG BEVESTIGEN","Een aanvraag voor {count} kaarten versturen?","Het totaal is {amount}. Controleer je selectie:","Ik bevestig dat ik deze aanvraag per e-mail naar de verkoper wil sturen. De verkoper neemt contact op via mijn Vinted-gebruikersnaam.","Terug","Bevestigen en versturen","AANVRAAG BEVESTIGD","Je kaarten zijn gereserveerd!","De verkoper heeft de e-mail ontvangen en neemt contact op via Vinted.","De aanvraag is opgeslagen, maar de e-mail is niet verzonden.","Reservebericht kopiëren"],
pt:["CARTÕES PADRÃO","Todos os cartões com numeração normal","CARTÕES NÚMERO 1 E 13","Os cartões número 1 e 13 de cada país","CARTÕES FWC","Todos os cartões da série FWC","cartões disponíveis","O CATÁLOGO","Cartões disponíveis","Pesquisar cartão ou país...","{count} tipos de cartões em stock","disponíveis","{count} em stock","Esgotado","A tua seleção está vazia.","Adiciona cartões do catálogo.","Subtotal","Total","Nenhum cartão corresponde à pesquisa.","Tens pedidos pendentes.","{orders} pedido(s) · {units} cartões no total · {unique} referências únicas · {amount}. O vendedor recebeu o pedido e irá contactar-te no Vinted.","A TUA SELEÇÃO","Carrinho","Limpar seleção","Os cartões são reservados após a confirmação","CONFIRMAR PEDIDO","Enviar um pedido de {count} cartões?","O total é {amount}. Confirma a tua seleção:","Confirmo que quero enviar este pedido ao vendedor por e-mail. O vendedor irá contactar-me através do meu nome de utilizador Vinted.","Voltar","Confirmar e enviar","PEDIDO CONFIRMADO","Os teus cartões estão reservados!","O vendedor recebeu o e-mail e irá contactar-te no Vinted.","O pedido foi guardado, mas o e-mail não foi enviado.","Copiar mensagem alternativa"],
pl:["KARTY STANDARDOWE","Wszystkie zwykłe numerowane karty","KARTY NUMER 1 I 13","Karty numer 1 i 13 każdego kraju","KARTY FWC","Wszystkie karty z serii FWC","dostępnych kart","KATALOG","Dostępne karty","Szukaj karty lub kraju...","{count} rodzajów kart w magazynie","dostępne","{count} w magazynie","Wyprzedane","Twój wybór jest pusty.","Dodaj karty z katalogu.","Suma częściowa","Razem","Brak kart pasujących do wyszukiwania.","Masz oczekujące zamówienia.","{orders} zamówień · łącznie {units} kart · {unique} unikalnych pozycji · {amount}. Sprzedawca otrzymał zamówienie i skontaktuje się przez Vinted.","TWÓJ WYBÓR","Koszyk","Wyczyść wybór","Karty zostaną zarezerwowane po potwierdzeniu","POTWIERDŹ ZAMÓWIENIE","Wysłać zamówienie na {count} kart?","Razem: {amount}. Sprawdź swój wybór:","Potwierdzam wysłanie zamówienia sprzedawcy e-mailem. Sprzedawca skontaktuje się ze mną przez nazwę użytkownika Vinted.","Wróć","Potwierdź i wyślij","ZAMÓWIENIE POTWIERDZONE","Twoje karty są zarezerwowane!","Sprzedawca otrzymał e-mail i skontaktuje się przez Vinted.","Zamówienie zapisano, ale e-mail nie został wysłany.","Kopiuj wiadomość zapasową"],
cs:["STANDARDNÍ KARTY","Všechny běžně číslované karty","KARTY ČÍSLO 1 A 13","Karty číslo 1 a 13 každé země","KARTY FWC","Všechny karty série FWC","dostupných karet","KATALOG","Dostupné karty","Hledat kartu nebo zemi...","{count} druhů karet skladem","dostupné","{count} skladem","Vyprodáno","Váš výběr je prázdný.","Přidejte karty z katalogu.","Mezisoučet","Celkem","Žádné karty neodpovídají hledání.","Máte nevyřízené požadavky.","{orders} požadavků · celkem {units} karet · {unique} jedinečných položek · {amount}. Prodejce požadavek obdržel a kontaktuje vás na Vinted.","VÁŠ VÝBĚR","Košík","Vymazat výběr","Karty budou rezervovány po potvrzení","POTVRDIT POŽADAVEK","Odeslat požadavek na {count} karet?","Celkem: {amount}. Zkontrolujte výběr:","Potvrzuji odeslání tohoto požadavku prodejci e-mailem. Prodejce mě kontaktuje přes mé uživatelské jméno Vinted.","Zpět","Potvrdit a odeslat","POŽADAVEK POTVRZEN","Vaše karty jsou rezervovány!","Prodejce obdržel e-mail a kontaktuje vás na Vinted.","Požadavek byl uložen, ale e-mail nebyl odeslán.","Kopírovat záložní zprávu"],
sk:["ŠTANDARDNÉ KARTY","Všetky bežne číslované karty","KARTY ČÍSLO 1 A 13","Karty číslo 1 a 13 každej krajiny","KARTY FWC","Všetky karty série FWC","dostupných kariet","KATALÓG","Dostupné karty","Hľadať kartu alebo krajinu...","{count} druhov kariet na sklade","dostupné","{count} na sklade","Vypredané","Váš výber je prázdny.","Pridajte karty z katalógu.","Medzisúčet","Celkom","Žiadne karty nezodpovedajú hľadaniu.","Máte čakajúce požiadavky.","{orders} požiadaviek · spolu {units} kariet · {unique} jedinečných položiek · {amount}. Predajca požiadavku prijal a kontaktuje vás na Vinted.","VÁŠ VÝBER","Košík","Vymazať výber","Karty budú rezervované po potvrdení","POTVRDIŤ POŽIADAVKU","Odoslať požiadavku na {count} kariet?","Celkom: {amount}. Skontrolujte výber:","Potvrdzujem odoslanie tejto požiadavky predajcovi e-mailom. Predajca ma kontaktuje cez moje používateľské meno Vinted.","Späť","Potvrdiť a odoslať","POŽIADAVKA POTVRDENÁ","Vaše karty sú rezervované!","Predajca dostal e-mail a kontaktuje vás na Vinted.","Požiadavka bola uložená, ale e-mail nebol odoslaný.","Kopírovať záložnú správu"],
hu:["NORMÁL KÁRTYÁK","Minden normál számozású kártya","1-ES ÉS 13-AS KÁRTYÁK","Minden ország 1-es és 13-as kártyája","FWC KÁRTYÁK","Az FWC sorozat összes kártyája","elérhető kártya","KATALÓGUS","Elérhető kártyák","Kártya vagy ország keresése...","{count} kártyatípus készleten","elérhető","{count} készleten","Elfogyott","A kiválasztás üres.","Adj hozzá kártyákat a katalógusból.","Részösszeg","Összesen","Nincs találat.","Függőben lévő kéréseid vannak.","{orders} kérés · összesen {units} kártya · {unique} egyedi tétel · {amount}. Az eladó megkapta a kérést, és Vinteden kapcsolatba lép veled.","KIVÁLASZTÁSOD","Kosár","Kiválasztás törlése","A kártyákat megerősítés után foglaljuk le","KÉRÉS MEGERŐSÍTÉSE","Elküldöd a kérést {count} kártyára?","A végösszeg {amount}. Ellenőrizd a kiválasztást:","Megerősítem, hogy e-mailben elküldöm ezt a kérést az eladónak. Az eladó a Vinted felhasználónevemen keresztül keres meg.","Vissza","Megerősítés és küldés","KÉRÉS MEGERŐSÍTVE","A kártyáidat lefoglaltuk!","Az eladó megkapta az e-mailt, és Vinteden keres meg.","A kérés mentve, de az e-mail nem lett elküldve.","Tartalék üzenet másolása"],
sv:["STANDARDKORT","Alla kort med vanlig numrering","KORT NUMMER 1 OCH 13","Kort nummer 1 och 13 från varje land","FWC-KORT","Alla kort i FWC-serien","tillgängliga kort","KATALOGEN","Tillgängliga kort","Sök kort eller land...","{count} korttyper i lager","tillgängliga","{count} i lager","Slutsåld","Ditt urval är tomt.","Lägg till kort från katalogen.","Delsumma","Totalt","Inga kort matchar sökningen.","Du har väntande förfrågningar.","{orders} förfrågningar · {units} kort totalt · {unique} unika referenser · {amount}. Säljaren har fått din förfrågan och kontaktar dig på Vinted.","DITT URVAL","Korg","Rensa urval","Korten reserveras efter bekräftelse","BEKRÄFTA FÖRFRÅGAN","Skicka en förfrågan om {count} kort?","Totalt: {amount}. Kontrollera ditt urval:","Jag bekräftar att förfrågan ska mejlas till säljaren. Säljaren kontaktar mig via mitt Vinted-användarnamn.","Tillbaka","Bekräfta och skicka","FÖRFRÅGAN BEKRÄFTAD","Dina kort är reserverade!","Säljaren har fått mejlet och kontaktar dig på Vinted.","Förfrågan sparades, men mejlet skickades inte.","Kopiera reservmeddelande"],
da:["STANDARDKORT","Alle kort med almindelig nummerering","KORT NUMMER 1 OG 13","Kort nummer 1 og 13 fra hvert land","FWC-KORT","Alle kort i FWC-serien","tilgængelige kort","KATALOGET","Tilgængelige kort","Søg efter kort eller land...","{count} korttyper på lager","tilgængelige","{count} på lager","Udsolgt","Dit udvalg er tomt.","Tilføj kort fra kataloget.","Subtotal","I alt","Ingen kort matcher din søgning.","Du har ventende forespørgsler.","{orders} forespørgsel(er) · {units} kort i alt · {unique} unikke referencer · {amount}. Sælgeren har modtaget din forespørgsel og kontakter dig på Vinted.","DIT UDVALG","Kurv","Ryd udvalg","Kortene reserveres efter bekræftelse","BEKRÆFT FORESPØRGSEL","Send en forespørgsel på {count} kort?","I alt: {amount}. Kontrollér dit udvalg:","Jeg bekræfter, at forespørgslen skal sendes til sælgeren via e-mail. Sælgeren kontakter mig via mit Vinted-brugernavn.","Tilbage","Bekræft og send","FORESPØRGSEL BEKRÆFTET","Dine kort er reserveret!","Sælgeren har modtaget e-mailen og kontakter dig på Vinted.","Forespørgslen blev gemt, men e-mailen blev ikke sendt.","Kopiér reservemeddelelse"],
fi:["VAKIOKORTIT","Kaikki tavallisesti numeroidut kortit","KORTIT NUMERO 1 JA 13","Jokaisen maan kortit numero 1 ja 13","FWC-KORTIT","Kaikki FWC-sarjan kortit","korttia saatavilla","LUETTELO","Saatavilla olevat kortit","Hae korttia tai maata...","{count} korttityyppiä varastossa","saatavilla","{count} varastossa","Loppuunmyyty","Valintasi on tyhjä.","Lisää kortteja luettelosta.","Välisumma","Yhteensä","Hakua vastaavia kortteja ei löytynyt.","Sinulla on odottavia pyyntöjä.","{orders} pyyntöä · yhteensä {units} korttia · {unique} eri viitettä · {amount}. Myyjä sai pyyntösi ja ottaa yhteyttä Vintedissä.","VALINTASI","Ostoskori","Tyhjennä valinta","Kortit varataan vahvistuksen jälkeen","VAHVISTA PYYNTÖ","Lähetetäänkö pyyntö {count} kortista?","Yhteensä {amount}. Tarkista valintasi:","Vahvistan, että haluan lähettää pyynnön myyjälle sähköpostitse. Myyjä ottaa minuun yhteyttä Vinted-käyttäjänimelläni.","Takaisin","Vahvista ja lähetä","PYYNTÖ VAHVISTETTU","Korttisi on varattu!","Myyjä sai sähköpostin ja ottaa yhteyttä Vintedissä.","Pyyntö tallennettiin, mutta sähköpostia ei lähetetty.","Kopioi varaviesti"],
ro:["CĂRȚI STANDARD","Toate cărțile cu numerotare obișnuită","CĂRȚILE NUMĂRUL 1 ȘI 13","Cărțile numărul 1 și 13 din fiecare țară","CĂRȚI FWC","Toate cărțile din seria FWC","cărți disponibile","CATALOGUL","Cărți disponibile","Caută o carte sau o țară...","{count} tipuri de cărți în stoc","disponibile","{count} în stoc","Epuizată","Selecția ta este goală.","Adaugă cărți din catalog.","Subtotal","Total","Nicio carte nu corespunde căutării.","Ai cereri în așteptare.","{orders} cereri · {units} cărți în total · {unique} referințe unice · {amount}. Vânzătorul a primit cererea și te va contacta pe Vinted.","SELECȚIA TA","Coș","Golește selecția","Cărțile sunt rezervate după confirmare","CONFIRMĂ CEREREA","Trimiți o cerere pentru {count} cărți?","Totalul este {amount}. Verifică selecția:","Confirm că doresc să trimit această cerere vânzătorului prin e-mail. Vânzătorul mă va contacta prin numele meu de utilizator Vinted.","Înapoi","Confirmă și trimite","CERERE CONFIRMATĂ","Cărțile tale sunt rezervate!","Vânzătorul a primit e-mailul și te va contacta pe Vinted.","Cererea a fost salvată, dar e-mailul nu a fost trimis.","Copiază mesajul de rezervă"],
el:["ΤΥΠΙΚΕΣ ΚΑΡΤΕΣ","Όλες οι κάρτες με κανονική αρίθμηση","ΚΑΡΤΕΣ ΑΡΙΘΜΟΣ 1 ΚΑΙ 13","Οι κάρτες 1 και 13 κάθε χώρας","ΚΑΡΤΕΣ FWC","Όλες οι κάρτες της σειράς FWC","διαθέσιμες κάρτες","Ο ΚΑΤΑΛΟΓΟΣ","Διαθέσιμες κάρτες","Αναζήτηση κάρτας ή χώρας...","{count} τύποι καρτών σε απόθεμα","διαθέσιμες","{count} σε απόθεμα","Εξαντλήθηκε","Η επιλογή σας είναι κενή.","Προσθέστε κάρτες από τον κατάλογο.","Μερικό σύνολο","Σύνολο","Δεν βρέθηκαν κάρτες.","Έχετε αιτήματα σε αναμονή.","{orders} αιτήματα · {units} κάρτες συνολικά · {unique} μοναδικές αναφορές · {amount}. Ο πωλητής έλαβε το αίτημα και θα επικοινωνήσει μέσω Vinted.","Η ΕΠΙΛΟΓΗ ΣΑΣ","Καλάθι","Εκκαθάριση επιλογής","Οι κάρτες δεσμεύονται μετά την επιβεβαίωση","ΕΠΙΒΕΒΑΙΩΣΗ ΑΙΤΗΜΑΤΟΣ","Αποστολή αιτήματος για {count} κάρτες;","Το σύνολο είναι {amount}. Ελέγξτε την επιλογή:","Επιβεβαιώνω ότι θέλω να σταλεί το αίτημα στον πωλητή μέσω email. Ο πωλητής θα επικοινωνήσει μέσω του ονόματός μου στο Vinted.","Πίσω","Επιβεβαίωση και αποστολή","ΤΟ ΑΙΤΗΜΑ ΕΠΙΒΕΒΑΙΩΘΗΚΕ","Οι κάρτες σας δεσμεύτηκαν!","Ο πωλητής έλαβε το email και θα επικοινωνήσει μέσω Vinted.","Το αίτημα αποθηκεύτηκε, αλλά το email δεν στάλθηκε.","Αντιγραφή εφεδρικού μηνύματος"],
lt:["STANDARTINĖS KORTELĖS","Visos įprastai sunumeruotos kortelės","1 IR 13 NUMERIO KORTELĖS","Kiekvienos šalies 1 ir 13 numerio kortelės","FWC KORTELĖS","Visos FWC serijos kortelės","kortelių galima įsigyti","KATALOGAS","Galimos kortelės","Ieškoti kortelės arba šalies...","{count} rūšių kortelių sandėlyje","galimos","{count} sandėlyje","Išparduota","Jūsų pasirinkimas tuščias.","Pridėkite kortelių iš katalogo.","Tarpinė suma","Iš viso","Paiešką atitinkančių kortelių nėra.","Turite laukiančių užklausų.","{orders} užklausos · iš viso {units} kortelių · {unique} unikalios pozicijos · {amount}. Pardavėjas gavo užklausą ir susisieks per Vinted.","JŪSŲ PASIRINKIMAS","Krepšelis","Išvalyti pasirinkimą","Kortelės rezervuojamos patvirtinus","PATVIRTINTI UŽKLAUSĄ","Siųsti užklausą dėl {count} kortelių?","Iš viso {amount}. Patikrinkite pasirinkimą:","Patvirtinu, kad noriu išsiųsti šią užklausą pardavėjui el. paštu. Pardavėjas susisieks per mano Vinted naudotojo vardą.","Atgal","Patvirtinti ir siųsti","UŽKLAUSA PATVIRTINTA","Jūsų kortelės rezervuotos!","Pardavėjas gavo el. laišką ir susisieks per Vinted.","Užklausa išsaugota, bet el. laiškas neišsiųstas.","Kopijuoti atsarginę žinutę"]
};
for(const [language,values] of Object.entries(fullLocalePacks)) extraTranslations[language]=Object.assign(extraTranslations[language]||{},Object.fromEntries(fullLocaleKeys.map((key,index)=>[key,values[index]])));
